...
namespace Inclive
{
	...
	public class DotnetAD
	{
		...
		public static string ADAdminUser = "mekeocha";// = "administrator"; //Administrator username of DC
		public static string ADAdminPassword = "Ekeocha_2010";// = "password"; //Password of admin user on DC

		//This needs to have the domain name or IP address on this line
        public static string ADFullPath = "LDAP://cldc2.howard.edu";
		
		//This must be the domain name of the domain controller (not the computer name, just the domain name)
		public static string ADServer = "cldc2.howard.edu";// = "sakura.com";
...
//			oDE.Close();
		...
		public static void AddUserToGroup(string UserName, string GroupName)
		{
			...
			g.Invoke("Move",new Object[]{user.Path});
			g.CommitChanges();
